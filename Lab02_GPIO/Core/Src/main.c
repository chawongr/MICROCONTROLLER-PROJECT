...
const pin[10]={GPIOF,GPIOE,GPIOE,GPIOF,GPIOE,GPIOF,GPIOG,GPIOG};
uint16_t LED[10]={GPIO_PIN_13,GPIO_PIN_9,GPIO_PIN_11,GPIO_PIN_14,GPIO_PIN_13,GPIO_PIN_15,GPIO_PIN_14,GPIO_PIN_9};
